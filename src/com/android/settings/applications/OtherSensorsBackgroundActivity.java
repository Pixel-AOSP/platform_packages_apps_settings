...
public class OtherSensorsBackgroundActivity extends SettingsPreferenceFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mEmpty.setText(R.string.other_sensors_background_empty_text);
        ...
        for (ApplicationInfo app : apps) {
            ...
            pref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    mAppOpsManager.setMode(AppOpsManager.OP_OTHER_SENSORS_BACKGROUND, getPackageUid(pkg), pkg,
    ...
    public void updateState(SwitchPreference preference, String pkg) {
        final int mode = mAppOpsManager
                .checkOpNoThrow(AppOpsManager.OP_OTHER_SENSORS_BACKGROUND, getPackageUid(pkg), pkg);
